        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="text-sm border-l border-gray-200 pl-4 h-10 hidden md:flex flex-col justify-center">
                <p className="font-medium text-gray-900 leading-tight">{user?.fullName || 'Admin User'}</p>
                <p className="text-xs text-gray-500 leading-tight font-medium">ID: {user?.id || 'N/A'}</p>
              </div>
              <button
